...
default theme, `theme_sage()`, which is currently just `theme_gray()` but with
Lato as the font family and a larger default font size. Lato must be installed
for this theme to work. See the Fonts section below, and `?import_lato` for more
information.
